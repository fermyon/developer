...
This command downloads and unpacks the latest Spin binary in the current directory. It's highly recommended to add Spin to a folder, which is on your path, e.g.:
