...
Spin is **open source** and **built on standards**, meaning you can take your Spin applications anywhere.  There are [Spin implementations for local development](see-what-people-have-built-with-spin), for self-hosted servers, for Kubernetes, and for cloud-hosted services.
