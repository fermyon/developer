...
- [Installing Templates](#installing-templates)
  - [Installing From a Git Repository](#installing-from-a-git-repository)
...
To install templates from a Git repository, run `spin templates install --git`.
...
The command installs _all_ templates in the repository.
...
If you want to check which templates come from which repositories, run `spin templates list --verbose`.
