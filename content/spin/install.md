...
>>>>>>> 5610248 (docs(spin/install): updates per v1.1.0)
$ cd spin
...
=======
> Please note: Spin v1.1.0 requires `wasmtime v7.0.0` which requires rustc 1.68.0 or newer. You can update Rust using the following command:
>>>>>>> 5610248 (docs(spin/install): updates per v1.1.0)
