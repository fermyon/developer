...
[extra]
url = "https://github.com/fermyon/developer/blob/main/content/spin/v2/v2/distributing-apps.md"
...
> Spin optimizes downloads using a local [registry cache](/spin/v2/v2/cache). When running an application from a remote registry, Spin always tries to check the registry for updates, even if the application has already been pulled. However, content files that are already pulled will not be re-downloaded. This applies even if they were downloaded as part of a different application.
