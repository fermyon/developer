...
[extra]
url = "https://github.com/fermyon/developer/blob/main/content/spin/v2/v2/build.md"
...
> If your build doesn't work, and your source code looks okay, you can [run `spin doctor`](/spin/v2/v2/troubleshooting-application-dev.md) to check for problems with your Spin configuration and tools.
