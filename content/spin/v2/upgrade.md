...
If you originally followed the documentation's [Cargo install method](/spin/v2/install#using-cargo-to-install-spin), please revisit to reinstall.
...
If you originally followed the documentation's [installer script method](/spin/v2/install#installing-spin), please revisit to reinstall.
...
If you followed the documentation's [install from source method](/spin/v2/install#building-spin-from-source) please revisit to reinstall.
...
In the above case, the [Cargo install method](/spin/v2/install#using-cargo-to-install-spin)'s installation will take precedence over the [installer script method](/spin/v2/install#installing-spin)'s installation. 
