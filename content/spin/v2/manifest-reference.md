...
|                         |            | Table (Experimental)       | * The registry, package and version of a component from a registry. This experimental source configuration must be a table containing a `registry` field for base domain of the registry, a `package` field for the package's name and a `version` field for the dot-separated version. | `{ registry = "ghcr.io", package = "hello-world", version="0.1" }` |
