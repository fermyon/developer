...
If you nevertheless want your component to fetch secrets directly from Vault, follow the [Dynamic Application Configuration](/v2/dynamic-configuration#vault-application-variable-provider) documentation.
