...
[extra]
url = "https://github.com/fermyon/developer/blob/main/content/spin/v2/v2/registry-tutorial.md"
...
First, follow [this guide](/spin/v2/v2/install) to ensure you have the latest version of Spin installed (this tutorial refers to Spin 1.0 and above). You can check the Spin version using the following command:
