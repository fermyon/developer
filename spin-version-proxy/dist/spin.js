...
var handleRequest = function (request) {
    return __awaiter(this, void 0, void 0, function () {
        var pattern, path, base, route, reqPath, resp, htmlResponse, err_1, latestSpinVersion, fullPath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pattern = /^\/v\d+\/*/;
                    path = request.headers["spin-path-info"];
                    if (!pattern.test(path)) return [3 /*break*/, 6];
                ...
                case 6:
                    latestSpinVersion = Config.get("latest_spin_version");
                    fullPath = request.headers["spin-full-url"];
                    fullPath = fullPath.replace("/spin/", "/spin/".concat(latestSpinVersion, "/"));
                    return [2 /*return*/, {
                            status: 302,
                            headers: {
                                location: fullPath
